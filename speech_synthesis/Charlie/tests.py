...
#
# In order to run these tests, copy this module to your tango_with_django_project/Charlie/ directory.
# Once this is complete, run $ python manage.py test Charlie.tests_chapter10
#
...
class Chapter10SessionPersistenceTests(TestCase):
    ...
    def test_visits_counter(self):
        ...
        """
        for i in range(0, 10):
            response = self.client.get(reverse('Charlie:index'))
...
class Chapter10ViewTests(TestCase):
    ...
    def test_about_view(self):
        ...
        """
        response = self.client.get(reverse('Charlie:index'))  # Call this first to ensure the counter is set.
        response = self.client.get(reverse('Charlie:about'))
        content = response.content.decode()
    ...
    def test_visits_passed_via_context(self):
        ...
        """
        response = self.client.get(reverse('Charlie:index'))  # Set the counter!
