...
class Tacotron2:
    """
    Modyfing version of Google's Tacotron 2
    """

    def __init__(self, checkpoint_path, hparams, gta=False, model_name="Tacotron"):
        """

        :param checkpoint_path: path to synthesizer weights
        :param hparams: Default hyperparameters
        :param gta: ground-truth-aligned
        :param model_name: model name; Tacotron
        """
